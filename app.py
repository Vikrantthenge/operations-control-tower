...
<a href="https://github.com/Vikrantthenge/Apps" target="_blank" style="text-decoration:none; display:inline-flex; align-items:center; gap:7px; background:#E6EDF7; padding:4px 10px; border-radius:999px;">
<i class="fa-brands fa-github" style="font-size:16px; color:#181717;"></i>
<span style="color:#181717; font-weight:600;">GitHub</span>
</a>
</div>
